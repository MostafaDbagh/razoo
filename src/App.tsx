import { Scissors, Clock, MapPin, Award, Phone, Mail, CheckCircle } from 'lucide-react';
      ...
      <nav className="fixed w-full bg-black/95 backdrop-blur-sm z-50 border-b border-amber-600/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <button className="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-6 py-2.5 rounded-lg transition">
              Book Now
            </button>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-8 py-4 rounded-lg transition text-lg">
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            <a href="tel:+1234567890" className="flex items-center space-x-3 text-gray-300 hover:text-amber-500 transition">
              <Phone className="h-6 w-6" />
              <span className="text-lg">(123) 456-7890</span>
            </a>
            <a href="mailto:info@elitegrooming.com" className="flex items-center space-x-3 text-gray-300 hover:text-amber-500 transition">
              <Mail className="h-6 w-6" />
              <span className="text-lg">info@elitegrooming.com</span>
            </a>
            <div className="flex items-center space-x-3 text-gray-300">
              <MapPin className="h-6 w-6" />
              <span className="text-lg">Serving Metro Area</span>
            </div>
          </div>
          <button className="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-12 py-4 rounded-lg transition text-lg">
